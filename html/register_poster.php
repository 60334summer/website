...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $sql = "SELECT id FROM user_poster WHERE username = ?";
    ...
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO user_poster (username, password) VALUES (?, ?)";
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt))
            {
              ...
              echo("<script>location.href = 'login_poster.php?';</script>");
            } 
            else
            {
...
<div class="container">
    ...
    <div class="col-md-6"> 
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Already have an account? <a style="color:#2E2F31" href="login_poster.php">Login here.</a></p>
        </form>
    </div>    
</div>  
