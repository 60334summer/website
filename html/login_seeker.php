...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($username_err) && empty($password_err)){
        ...
        $sql = "SELECT username, password FROM user_seeker WHERE username = ?";
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            echo("<script>location.href = 'welcome_seeker.php?';</script>");
                        } else{
...
<div class="container">
    ...
    <div class="col-md-6">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Don't have an account? <a style="color:black;" href="register_seeker.php">Sign up now</a>.</p>
        </form>
